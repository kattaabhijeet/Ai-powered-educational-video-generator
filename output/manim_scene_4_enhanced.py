...
class EnhancedScene(Scene):
    def construct(self):
        ...
        label_1 = Text("IP to Resolver", font_size=20, weight=BOLD, color=WHITE)
        ...
        label_3 = Text("Cache Icon", font_size=18, weight=BOLD, color=WHITE)
        ...
        # Arrow label with background (better visibility)
        label_4 = Text("IP to Computer", font_size=20, weight=BOLD, color=WHITE)
        ...
        label_6 = Text("Globe Icon", font_size=18, weight=BOLD, color=WHITE)
