...
class DynamicScene(Scene):
    def construct(self):
        ...
        rect_0 = Rectangle(width=2.0, height=1.5, color="#00d4ff", fill_opacity=0.2, stroke_width=3)
        rect_0.move_to([-4.0, 0.0, 0])
        label_0 = Text("Your Computer", font_size=24, color=WHITE)
        label_0.move_to(rect_0)
        elem_0 = VGroup(rect_0, label_0)

        arrow_1 = Arrow(start=[-2.0, 0.0, 0], end=[0.0, 0.0, 0], color="#00d4ff", stroke_width=4, buff=0.1)
        label_1 = Text("Request to Resolver", font_size=20, color=WHITE)
        ...
        elem_3 = Text("Cache Miss", font_size=36, color="#ff6b35")
        elem_3.move_to([0.0, 0.8, 0])

        arrow_4 = Arrow(start=[1.0, 0.0, 0], end=[3.0, 0.0, 0], color="#ff6b35", stroke_width=4, buff=0.1)
        label_4 = Text("Forward to Root", font_size=20, color=WHITE)
        label_4.next_to(arrow_4, UP, buff=0.2)
        elem_4 = VGroup(arrow_4, label_4)

        rect_5 = Rectangle(width=2.0, height=1.5, color="#ff6b35", fill_opacity=0.2, stroke_width=3)
        rect_5.move_to([4.0, 0.0, 0])
        label_5 = Text("Root Server", font_size=24, color=WHITE)
